APIKYE = '46e136c5e05e4afc85c40626240308';
...
async function getData(APIKYE, cityName){
    const promise = await fetch(`https://api.weatherapi.com/v1/current.json?key=${APIKYE}&q=${cityName}&aqi=yes`);
